...
const ApplyForm = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setMessage({
        type: "success",
        text: "✅ تم التسجيل بنجاح. سيتم إرسال رابط الدورة إلى بريدك بعد 7 أيام.",
      });
          ...
          <div className="col-md-6 col-lg-5">
            ...
            <div className="text-center mb-4">
              <div className="mb-3 position-relative d-inline-block">
                ...
                {/* Replace 'logo-url.png' with your actual path later */}
                <img
            ...
            >
              <div className="mb-4">
                ...
                <p className="small text-secondary">سجّل الآن، واحصل على الوصول خلال 7 أيام</p>
              </div>
